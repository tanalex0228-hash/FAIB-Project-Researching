...
grant usage on schema research to macro_reader;
grant select on all tables in schema public to macro_reader;
grant select on all tables in schema research to macro_reader;
alter default privileges in schema public grant select on tables to macro_reader;
alter default privileges in schema research grant select on tables to macro_reader;
